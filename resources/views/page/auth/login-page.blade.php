@extends('page.fullscreen-layout')
                        ...
                        <div>
                            ...
                            <div x-data="{ showPassword: false }" class="relative">
                                <input
                                    ...
                                    required
                                    placeholder="********"
                                    class="h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-4 pr-11
                                    text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-500 focus:ring-3
                                    focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90" />
            ...
            <div class="z-1 flex items-center justify-center">
                ...
                <div class="flex max-w-xs flex-col items-center">
                    <a href="/" class="mb-4 block">
                        <img src="./images/logo/my.jpeg" alt="Logo" />
                    </a>
                    <p class="text-center text-gray-400 dark:text-white/60">
                        Sistem Manajemen Inventori Warung Berkah
                    </p>
                </div>
            </div>
        </div>
