...
<x-common.page-breadcrumb pageTitle="Stock Outs" />
...
<div class="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
    ...
    <div class="flex flex-col gap-3 px-5 mb-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
        ...
        <div class="flex items-center gap-3">
            ...
            {{-- SEARCH --}}
            <form method="GET" action="{{ route('stock-outs.index') }}" class="flex items-center gap-2">
                <input type="text"
                       name="search"
            ...
            <div class="relative group">
                ...
                <div class="absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                    ...
                    <a href="{{ route('stock-outs.index', ['filter' => 'today', 'search' => request('search')]) }}"
                       class="block px-4 py-2 text-sm hover:bg-gray-100">
                        Hari Ini
                    </a>

                    <a href="{{ route('stock-outs.index', ['filter' => '7days', 'search' => request('search')]) }}"
                       class="block px-4 py-2 text-sm hover:bg-gray-100">
                        7 Hari Terakhir
                    </a>

                    <a href="{{ route('stock-outs.index', ['filter' => '1month', 'search' => request('search')]) }}"
                       class="block px-4 py-2 text-sm hover:bg-gray-100">
                        1 Bulan Terakhir
                    </a>

                    <a href="{{ route('stock-outs.index', ['filter' => '1year', 'search' => request('search')]) }}"
                       class="block px-4 py-2 text-sm hover:bg-gray-100">
                        1 Tahun Terakhir
                    </a>
                ...
                @forelse($stockOuts as $stock)
                    <tr class="border-t">
                        ...
                        <td class="px-4 py-4 text-sm text-gray-500 text-center">
                            ...
                            <td class="px-4 py-3 font-medium text-red-600 text-center">
                                -{{ $stock->quantity }}
                            </td>
                        ...
                        <td class="px-4 py-4 text-center">
                            <div class="flex justify-center gap-2">
                                ...
                                {{-- EDIT --}}
                                <a href="{{ route('stock-outs.edit', $stock) }}"
    ...
    <div class="flex justify-center items-center gap-2">
        ...
        <script>
            function openDeleteModal(id) {
                ...
                form.action = `/delete-stock-out/${id}`;
